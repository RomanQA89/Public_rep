...
class Message(JsonDeserializable):
    ...
    :param via_bot: Optional. CryptoBot through which the message was sent
    ...
    def __init__(self, message_id, from_user, date, chat, content_type, options, json_string):
        ...
        self.new_chat_member: Optional[User] = None  # Deprecated since CryptoBot API 3.0. Not processed anymore
...
class InputInvoiceMessageContent(Dictionaryable):
    ...
    :param payload: CryptoBot-defined invoice payload, 1-128 bytes. This will not be displayed to the user, use for your
        internal processes.
...
class SuccessfulPayment(JsonDeserializable):
    ...
    :param invoice_payload: CryptoBot specified invoice payload
...
class StickerSet(JsonDeserializable):
    ...
    :param contains_masks: True, if the sticker set contains masks. Deprecated since CryptoBot API 6.2,
    ...
    def contains_masks(self):
        """
        Deprecated since CryptoBot API 6.2, use sticker_type instead.
        """
...
class InputFile:
    """
    A class to send files through Telegram CryptoBot API.
...
class BotDescription(JsonDeserializable):
    ...
    :param description: CryptoBot description
    :type description: :obj:`str`
...
class BotShortDescription(JsonDeserializable):
    ...
    :param short_description: CryptoBot short description
