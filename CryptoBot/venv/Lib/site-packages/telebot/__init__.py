...
class TeleBot:
    """
    This is the main synchronous class for CryptoBot.
    ...
    def set_webhook(self, url: Optional[str]=None, certificate: Optional[Union[str, Any]]=None, max_connections: Optional[int]=None,
        ...
        If specified, the request will contain a header “X-Telegram-CryptoBot-Api-Secret-Token” with the secret token as content.
        ...
        :param secret_token: A secret token to be sent in a header “X-Telegram-CryptoBot-Api-Secret-Token” in every webhook request, 1-256 characters.
    ...
    def log_out(self) -> bool:
        """
        Use this method to log out from the cloud CryptoBot API server before launching the bot locally.
        ...
        but will not be able to log in back to the cloud CryptoBot API server for 10 minutes.
        Returns True on success.
    ...
    def send_invoice(
        ...
        :param invoice_payload: CryptoBot-defined invoice payload, 1-128 bytes. This will not be displayed to the user,
    ...
    def create_invoice_link(self,
        ...
        :param payload: CryptoBot-defined invoice payload, 1-128 bytes. This will not be displayed to the user,
            use for your internal processes.
    ...
    def answer_pre_checkout_query(
            ...
            error_message: Optional[str]=None) -> bool:
        """
        Once the user has confirmed their payment and shipping details, the CryptoBot API sends the final confirmation in the form of an Update with the
        field pre_checkout_query. Use this method to respond to such pre-checkout queries.
        On success, True is returned.

        .. note::
            The CryptoBot API must receive an answer within 10 seconds after the pre-checkout query was sent.
    ...
    def create_new_sticker_set(
        ...
        :param contains_masks: Pass True, if a set of mask stickers should be created. Deprecated since CryptoBot API 6.2,
